...
def regressor(X_ftrain,train_utilities,X_ftest,test_utilities):
...
print "adjectives"
regressor(trainadj,train_utilities,testadj,test_utilities)
print "syntacs"
regressor(trainsyntac,train_utilities,testsyntac,test_utilities)
print "distances"
regressor(traindist,train_utilities,testdist,test_utilities)
print"adj+syntac"
regressor(np.concatenate((trainadj,trainsyntac),axis=1),train_utilities,np.concatenate((testadj,testsyntac),axis=1),test_utilities)
print "all togethert"
regressor(X_ftrain,train_utilities,X_ftest,test_utilities)
